...
class NashEquilibriumCalculator(tk.Tk):
    ...
    def output_help(self):
        tkinter.messagebox.showinfo('Output',
            ...
            "choice of probability and the opponent's corresponding expected payoff are explicited. "
            "When the information for both is explicited, this corresponds to a nonpure "
            "Nash equilibrium, with the two regret lines intersecting at a position "
    ...
    def display_graphics_and_special_information(self):
        ...
        if self.game_matrix.get_payoffs():
            ...
            self.display_special_information(self.special_expectations, self.expectations, self.probas)
    ...
    def draw_regret_lines_and_highlight_cells(self, graph, segments, cells):
        ...
        if not segments_0[0] and segments_0[2]:
            if not segments_1[0] and segments_1[2]:
                ...
                graph.create_oval(103, 3, 107, 7, fill = self.nash_colour, outline = self.nash_colour)
                ...
                graph.create_line(segments_1[1] * 100 + 5, 5, segments_1[1] * 100 + 5, 105,
                                  fill = self.charlie_colour, width = 2)
                graph.create_line(segments_1[1] * 100 + 5, 105, 105, 105, fill = self.charlie_colour,
                                  width = 2)
                graph.create_oval(103, 103, 107, 107, fill = self.nash_colour,
                                  outline = self.nash_colour)
                cells[1][0].config(fg = self.nash_colour)
            ...
            if not segments_1[0] and segments_1[2]:
                ...
                graph.create_line(5, 5, 5, 105, fill = self.charlie_colour, width = 2)
                graph.create_line(5, 5, 105, 5, fill = self.charlie_colour, width = 2)
                graph.create_oval(3, 103, 7, 107, fill = self.nash_colour, outline = self.nash_colour)
                graph.create_oval(103, 3, 107, 7, fill = self.nash_colour, outline = self.nash_colour)
                cells[1][1].config(fg = self.nash_colour)
            ...
            if not segments_1[0] and segments_1[2]:
                graph.create_line(5, (1 - segments_0[1]) * 100 + 5, 5, 105, fill = self.ruth_colour,
                                  width = 2)
                graph.create_line(5, (1 - segments_0[1]) * 100 + 5, 105, (1 - segments_0[1]) * 100 + 5,
                                  fill = self.ruth_colour, width = 2)
                graph.create_line(105, 5, 105, (1 - segments_0[1]) * 100 + 5, fill = self.ruth_colour,
                                  width = 2)
                graph.create_line(5, 5, 105, 5, fill = self.charlie_colour, width = 2)
                graph.create_oval(103, 3, 107, 7, fill = self.nash_colour, outline = self.nash_colour)
                cells[1][1].config(fg = self.nash_colour)
                ...
                graph.create_line(105, 5, 105, (1 - segments_0[1]) * 100 + 5, fill = self.ruth_colour,
                                  width = 2)
                graph.create_line(5, 5, 5, (1 - segments_0[1]) * 100 + 5, fill = self.charlie_colour,
                                  width = 2)
                graph.create_line(5, 5, 105, 5, fill = self.charlie_colour, width = 2)
                graph.create_line(5, (1 - segments_0[1]) * 100 + 5, 5, 105, fill = self.nash_colour,
                                  width = 2)
                graph.create_oval(3, 103, 7, 107, fill = self.nash_colour, outline = self.nash_colour)
                graph.create_oval(103, 3, 107, 7, fill = self.nash_colour, outline = self.nash_colour)
                cells[1][1].config(fg = self.nash_colour)
                ...
                graph.create_line(5, (1 - segments_0[1]) * 100 + 5, 105, (1 - segments_0[1]) * 100 + 5,
                                  fill = self.ruth_colour, width = 2)
                graph.create_line(105, 5, 105, (1 - segments_0[1]) * 100 + 5, fill = self.nash_colour,
                                  width = 2)
            ...
            if not segments_1[0] and segments_1[2]:
                ...
                graph.create_line(5, 5, 5, 105, fill = self.ruth_colour, width = 2)
                graph.create_line(5, 5, segments_1[1] * 100 + 5, 5, fill = self.ruth_colour, width = 2)
                graph.create_line(5, 105, segments_1[1] * 100 + 5, 105, fill = self.charlie_colour,
                                  width = 2)
                graph.create_line(segments_1[1] * 100 + 5, 5, segments_1[1] * 100 + 5, 105,
                                  fill = self.charlie_colour, width = 2)
                ...
                graph.create_line(segments_1[1] * 100 + 5, 105, 105, 105, fill = self.charlie_colour,
                                  width = 2)
                graph.create_line(5, 5, segments_1[1] * 100 + 5, 5, fill = self.nash_colour, width = 2)
                graph.create_oval(3, 3, 7, 7, fill = self.nash_colour, outline = self.nash_colour)
                cells[0][1].config(fg = self.nash_colour)
            elif segments_1[0] == (0, 1) and segments_1[2] == (0, 0):
                graph.create_line(5, 5, 105, 5, fill = self.ruth_colour, width = 2)
            ...
            if not segments_1[0] and segments_1[2]:
                ...
                graph.create_line(5, (1 - segments_0[1]) * 100 + 5, 105, (1 - segments_0[1]) * 100 + 5,
                                  fill = self.ruth_colour, width = 2)
                graph.create_line(105, (1 - segments_0[1]) * 100 + 5, 105, 105, fill = self.ruth_colour,
                                  width = 2)
                graph.create_line(5, 5, 105, 5, fill = self.charlie_colour, width = 2)
                graph.create_oval(3, 3, 7, 7, fill = self.nash_colour, outline = self.nash_colour)
                cells[0][1].config(fg = self.nash_colour)
                ...
                graph.create_line(105, (1 - segments_0[1]) * 100 + 5, 105, 105, fill = self.ruth_colour,
                                  width = 2)
                graph.create_line(5, (1 - segments_0[1]) * 100 + 5, 5, 105, fill = self.charlie_colour,
                                  width = 2)
                graph.create_line(5, 5, 105, 5, fill = self.charlie_colour, width = 2)
                ...
                graph.create_line(105, 5, 105, (1 - segments_0[1]) * 100 + 5,
                                  fill = self.charlie_colour, width = 2)
                graph.create_line(5, 105, 105, 105, fill = self.charlie_colour, width = 2)
                graph.create_line(105, (1 - segments_0[1]) * 100 + 5, 105, 105, fill = self.nash_colour,
                                  width = 2)
                graph.create_oval(103, 103, 107, 107, fill = self.nash_colour,
                                  outline = self.nash_colour)
                cells[1][0].config(fg = self.nash_colour)
...
class GameMatrix(tk.Frame):
    ...
    def create_matrix(self):
        ...
        tk.Label(self, text = 'Ruth', fg = NashEquilibriumCalculator.ruth_colour).grid(columnspan = 2,
                                                                                       pady = 5)
    ...
    def get_payoffs(self):
        ...
        if not correct_input:
            tkinter.messagebox.showerror('Incorrect input',
                                         'Enter pairs of numbers separated by a comma and '
