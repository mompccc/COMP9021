...
for n in range(100, 1000):
    ...
    if i < 3:
        ...
        n += i
        continue
    print('({}, {}, {}) (equal to ('.format(n, n + 1, n + 2) +
          '{}^2+{}^2, '.format(sums_of_two_squares[n][0], sums_of_two_squares[n][1]) +
          '{}^2+{}^2, '.format(sums_of_two_squares[n + 1][0], sums_of_two_squares[n + 1][1]) +
          '{}^2+{}^2'.format(sums_of_two_squares[n + 2][0], sums_of_two_squares[n + 2][1]) +
          ')) is a solution.')
