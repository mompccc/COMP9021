...
class ElementaryCellularAutomata(tk.Tk):
    ...
    def __init__(self):
        ...
        tk.Label(self, width = 9, height = 1, textvariable = self.shown_rule_number,
                 fg = 'magenta').grid(row = 0, column = 1)
        ...
        tk.Label(self, width = 87, height = 1,
                 textvariable = self.shown_related_rule_numbers).grid(row = 1, column = 1)
    ...
    def display_rule_information(self):
        ...
        self.shown_related_rule_numbers.set('Mirrored rule: ' +
    ...
    def work_from_random_state(self):
        ...
        # ...
        line = [randint(0, 1) for _ in range(4 * self.nb_of_steps - 2)], [0] * (4 * self.nb_of_steps - 2)
