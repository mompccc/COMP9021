...
# The roots are automatically computed when the equation is created
...
class SecondOrderEquation:
    ...
    def __repr__(self):
        ...
        '''
        return 'SecondOrderEquation(a = {}, b = {}, c = {})'.format(self.a, self.b, self.c)
    ...
    def __str__(self):
        ...
        if self.a == 1:
            ...
            equation = '{}x^2'.format(self.a)
        if self.b == 1:
            equation += ' + x'
        elif self.b == -1:
            equation -= ' - x'           
        elif self.b > 0:
            equation += ' + {}x'.format(self.b)
        elif self.b < 0:
            equation += '- {}x'.format(-self.b)
        if self.c > 0:
            equation += ' + {}'.format(self.c)
        elif self.c < 0:
            equation += ' - {}'.format(-self.c)
